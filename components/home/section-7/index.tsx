...
export default function Section7() {
  return (
    <section className="relative h-[36rem] md:h-[40rem]">
      ...
      <Image src={section7BackgroundImage} alt="2000 trường học liên kết" className="hidden md:block absolute top-0 left-0 w-full h-full object-cover" />
      {/* section 7 bg image mobile */}
      <Image src={section7BackgroundImageMobile} alt="2000 trường học liên kết" className="block md:hidden absolute bottom-0 left-0 w-full object-cover" />
      {/* section 7 heading */}
