...
export default function Section6() {
  return (
    <section className="relative h-[48rem] bg-linear-7 pt-[3.5rem]">
      ...
      <Image src={section6BackgroundImage} alt="Các học sinh tiêu biểu" className="hidden md:block absolute top-0 right-0 -z-10 w-full h-full object-cover" />
      <Image src={section6Deco} alt="Các học sinh tiêu biểu" className="hidden md:block absolute bottom-0 left-0 w-full h-[37.8125rem]" />

      {/* section 6 bg img mobile */}
      <Image src={section6BackgroundImageMobile} alt="Các học sinh tiêu biểu" className="block md:hidden absolute top-0 left-0 w-full object-cover" />
    </section>
  )
}