...
export default function Section1() {
  return (
    <section className="w-full md:w-[97%] mx-auto mb-12 md:mb-20">
      ...
      <div className="my-8 mobile-width flex md:hidden flex-row py-3 bg-white rounded-xl shadow-section-1">
        <Link href="/" className="flex flex-col gap-4 w-1/4">
          <Image src={youtubeLearning} alt="youtube-learning" className="mx-auto" />
